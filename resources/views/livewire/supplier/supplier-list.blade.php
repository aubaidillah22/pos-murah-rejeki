<div>
        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-4 py-3 text-center text-sm text-gray-500">{{ $s->purchase_orders_count }}</td>
        ...
        <div class="bg-white rounded-xl shadow-2xl p-6 max-w-md w-full mx-4">
            ...
            <form wire:submit="save" class="space-y-3">
                ...
                <div>
                    ...
                    <input type="text" wire:model="contact_person" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm">
                </div>
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
        <div class="bg-white rounded-xl shadow-2xl p-6 max-w-sm w-full mx-4">
            <h3 class="text-lg font-semibold text-gray-800 mb-2">Hapus Supplier?</h3>
